...
void GestionCamions::createMainContent() {
  ...
  truckTable->setColumnWidth(5, 220); // Larger width for buttons
...
void GestionCamions::applyStyles() {
  QString styleSheet = R"(
        ...
        QComboBox QAbstractItemView { background-color: white; color: #333; selection-background-color: #A3C651; selection-color: white; border: 1px solid #ddd; }
        ...
        #exportPdfButton { background: #FF9800; color: white; border: none; border-radius: 8px; padding: 0 25px; font-size: 15px; font-weight: bold; }
