...
QT_BEGIN_NAMESPACE
namespace Ui { class gestion_des_poubelles; }
QT_END_NAMESPACE
...
private:
    ...
    void loadDataFromDB();
    void loadZones(); // Nouvelle méthode pour charger les zones
    ...
    QComboBox *etatCombo;
    QComboBox *idZoneCombo; // Changé de QLineEdit à QComboBox
    ...
    Ui::gestion_des_poubelles *ui;
    int currentEditingRow;
    int nextId;
    QLabel *userLabel; // Ajout du membre manquant
};
