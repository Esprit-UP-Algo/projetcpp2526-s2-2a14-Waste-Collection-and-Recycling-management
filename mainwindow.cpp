...
void MainWindow::setupLoginScreen()
{
    ...
    titleLogoLabel->setStyleSheet("font-size: 32px; font-weight: bold; color: #6FA85E; background: transparent;");
    ...
    titleLabel->setStyleSheet(
        "font-size: 16px; font-weight: bold; color: #000000; margin: 10px 0px; background: transparent;"
        );
    ...
    passwordLabel->setStyleSheet("font-size: 14px; font-weight: bold; color: #000000; background: transparent;");
...
QWidget* MainWindow::createSidebar()
{
    ...
    connect(recycleBtn, &QPushButton::clicked, this, &MainWindow::onRecyclageClicked);
